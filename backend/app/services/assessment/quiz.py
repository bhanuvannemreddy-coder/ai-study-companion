...
def get_question_history(
    ...
    rows = (
        ...
        .join(
            QuizAttempt,
            QuizQuestion.attempt_id == QuizAttempt.id,
        )
        .outerjoin(
            QuizAnswer,
            (
...
The previous generation did not pass validation.
Generate a fresh set of questions with different
wording and avoid all previous questions.
"""
